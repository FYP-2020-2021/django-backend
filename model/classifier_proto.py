...
def document_preprocessing(text, class_labels, vectorizer):
    ...
    model_path = os.path.join(dir_path,'prototype/Prototype_model.h5') # absolute zip file path
...
def run_model(text):
    vectorizer_file = "prototype/vectorizer.bin"
    path = os.path.abspath(__file__) # full path of your script
    dir_path = os.path.dirname(path) # full path of the directory of your script
    vectorizer_file_path = os.path.join(dir_path, vectorizer_file) # absolute zip file path
